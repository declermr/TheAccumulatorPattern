...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 5
    answer = count_cosines_from(4, 26, 0.78)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    # Test 3:
    expected = 12
    answer = count_cosines_from(12, 33, 0.12)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    # Test 4:
    expected = 9
    answer = count_cosines_from(1, 17, -0.24)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
    # Test 5:
    expected = 107
    answer = count_cosines_from(55, 345, 0.4)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    # Test 6:
    expected = 51
    answer = count_cosines_from(34, 106, -0.63)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.058123  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(4, 27)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    # Test 3:
    expected = 1.375995  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(13, 49)
