...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected2 = .19859  # This is APPROXIMATELY the correct answer.
    answer2 = sum_more_cosines(4, 8)
    print('Test 2 expected:', expected2, '(approximately)')
    print('       actual:  ', answer2)
    # Test 3:
    expected3 = -.06205  # This is APPROXIMATELY the correct answer.
    answer3 = sum_more_cosines(2, 7)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 2:
    expected2 = 27
    answer2 = count_sines_vs_cosines(27)
    print('Test 1 expected:', expected2)
    print('       actual:  ', answer2)
    # Test 3:
    expected3 = 1878
    answer3 = count_sines_vs_cosines(1876)
    print('Test 1 expected:', expected3)
    print('       actual:  ', answer3)
    # Test 4:
    expected4 = 75
    answer4 = count_sines_vs_cosines(73)
    print('Test 1 expected:', expected4)
    print('       actual:  ', answer4)
    # Test 5:
    expected5 = 923
    answer5 = count_sines_vs_cosines(923)
    print('Test 1 expected:', expected5)
    print('       actual:  ', answer5)
    # Test 1:
    expected6 = 19
    answer6 = count_sines_vs_cosines(18)
    print('Test 1 expected:', expected6)
    print('       actual:  ', answer6)
